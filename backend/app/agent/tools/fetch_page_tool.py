...
def make_page_fetch_tool(
    ...
    async def fetch_page(urls: list[str]) -> str:
        ...
        ЛИМИТ: РОВНО 2 вызова на одно сообщение пользователя. 
        Второй вызов предназначен ТОЛЬКО если нужно получить информацию из ссылок полученных в ходе первого вызова.
        Большее количество вызовов или повторных вызовов с другими URL или с теми же URL ЗАПРЕЩЁНО.
