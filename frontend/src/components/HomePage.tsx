...
export default function HomePage({
  ...
  return (
    <div className="relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto px-4 pt-24 sm:pt-28">
      ...
      <div className="relative z-10 flex min-h-full flex-col items-center justify-start pb-10 pt-2 sm:pt-4 md:flex-1 md:justify-center">
        ...
        <div className="relative mb-8 text-center sm:mb-10">
          <h1 className="mx-auto max-w-4xl text-balance text-[32px] font-black leading-[1.04] tracking-[-0.045em] text-slate-900 sm:text-[40px] md:text-[64px]">
            Остались вопросы?
            <br />
            <span className="text-slate-900">Спросите у нас</span>
          </h1>

          <p className="mx-auto mt-4 max-w-2xl text-balance text-[15px] leading-7 text-slate-600 md:mt-5 md:text-base">
        ...
        <div className="mt-10 flex max-w-3xl flex-wrap justify-center gap-2.5 pb-2 sm:mt-14">
        ...
        <AppDisclaimer className="mt-6 pb-5 md:mt-8 md:pb-0" />
      </div>
    </div>
  );
}
